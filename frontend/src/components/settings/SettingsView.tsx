...
function SettingsDetail({
  ...
  const genderText =
    gender === "male" ? "男" : gender === "female" ? "女" : "不显示";
    ...
    <div className="panel-scroll settings-detail">
      <div className="settings-content">
        <SettingsSection id="settings-account" title="账号">
          ...
          >
            {editingField === "nickname" && fieldError ? <span className="settings-row-error">{fieldError}</span> : null}
          </SettingsRow>
          ...
          >
            {editingField === "region" && fieldError ? <span className="settings-row-error">{fieldError}</span> : null}
          </SettingsRow>
          <SettingsRow
            label="个性签名"
            description="展示在联系人资料页"
            control={
              editingField === "signature" ? (
          ...
          >
            {editingField === "signature" && fieldError ? <span className="settings-row-error">{fieldError}</span> : null}
          </SettingsRow>
        </SettingsSection>
